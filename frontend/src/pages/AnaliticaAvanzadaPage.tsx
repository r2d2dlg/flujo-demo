...
import { FaChartLine, FaProjectDiagram, FaMoneyBillWave, FaCreditCard, FaCogs, FaCalculator, FaClipboardList, FaBalanceScale, FaFileInvoiceDollar, FaUsers, FaBriefcase, FaCashRegister, FaChartBar } from 'react-icons/fa';
