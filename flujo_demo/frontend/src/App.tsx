...
import EgresosPreliminaresConsolidadoPage from './pages/EgresosPreliminaresConsolidadoPage';
...
function AppContent() {
  ...
  return (
      ...
      <Route path="/admin/vendedores" element={<ProtectedRoute><VendedoresPage /></ProtectedRoute>} />
        ...
        <Route path="/cash-flows/egresos-preliminares" element={<ProtectedRoute><EgresosPreliminaresConsolidadoPage /></ProtectedRoute>} />
