...
DROP VIEW IF EXISTS v_pagos_tierra;

-- Drop existing table if exists
DROP TABLE IF EXISTS pagos_tierra;
...
data_with_totals AS (
    SELECT 
        ...
        -- Pass through all the monthly columns
        "2024_04", "2024_05", "2024_06", "2024_07", "2024_08", "2024_09", 
        "2024_10", "2024_11", "2024_12", "2025_01", "2025_02", "2025_03", 
...
totals AS (
    SELECT 
        ...
        'Total' as actividad,
        SUM(total_2024_2025) as total_2024_2025,
        SUM(total_2025_2026) as total_2025_2026,
        SUM(total_2026_2027) as total_2026_2027,
        SUM(total_2027_2028) as total_2027_2028,
        SUM("2024_04") as "2024_04", SUM("2024_05") as "2024_05", 
        SUM("2024_06") as "2024_06", SUM("2024_07") as "2024_07",
        SUM("2024_08") as "2024_08", SUM("2024_09") as "2024_09",
        SUM("2024_10") as "2024_10", SUM("2024_11") as "2024_11",
        SUM("2024_12") as "2024_12", SUM("2025_01") as "2025_01",
        SUM("2025_02") as "2025_02", SUM("2025_03") as "2025_03",
        SUM("2025_04") as "2025_04", SUM("2025_05") as "2025_05",
        SUM("2025_06") as "2025_06", SUM("2025_07") as "2025_07",
        SUM("2025_08") as "2025_08", SUM("2025_09") as "2025_09",
        SUM("2025_10") as "2025_10", SUM("2025_11") as "2025_11",
        SUM("2025_12") as "2025_12", SUM("2026_01") as "2026_01",
        SUM("2026_02") as "2026_02", SUM("2026_03") as "2026_03",
        SUM("2026_04") as "2026_04", SUM("2026_05") as "2026_05",
        SUM("2026_06") as "2026_06", SUM("2026_07") as "2026_07",
        SUM("2026_08") as "2026_08", SUM("2026_09") as "2026_09",
        SUM("2026_10") as "2026_10", SUM("2026_11") as "2026_11",
        SUM("2026_12") as "2026_12", SUM("2027_01") as "2027_01",
        SUM("2027_02") as "2027_02", SUM("2027_03") as "2027_03",
        SUM("2027_04") as "2027_04", SUM("2027_05") as "2027_05",
        SUM("2027_06") as "2027_06", SUM("2027_07") as "2027_07",
        SUM("2027_08") as "2027_08", SUM("2027_09") as "2027_09",
        SUM("2027_10") as "2027_10", SUM("2027_11") as "2027_11",
        SUM("2027_12") as "2027_12", SUM("2028_01") as "2028_01",
        SUM("2028_02") as "2028_02", SUM("2028_03") as "2028_03",
        SUM("2028_04") as "2028_04", SUM("2028_05") as "2028_05"
    FROM data_with_totals
    GROUP BY 1, 2
)
SELECT * FROM data_with_totals
UNION ALL
SELECT * FROM totals;

-- Grant permissions
GRANT SELECT, INSERT, UPDATE, DELETE ON pagos_tierra TO arturodlg;
GRANT SELECT ON v_pagos_tierra TO arturodlg;
GRANT USAGE ON pagos_tierra_id_seq TO arturodlg; 