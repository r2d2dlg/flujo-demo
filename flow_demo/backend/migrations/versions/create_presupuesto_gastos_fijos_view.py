...
Revision ID: create_presupuesto_gastos_fijos_view
Revises: create_presupuesto_gastos_fijos_table
...
revision: str = 'create_presupuesto_gastos_fijos_view'
down_revision: Union[str, None] = 'create_presupuesto_gastos_fijos_table'
